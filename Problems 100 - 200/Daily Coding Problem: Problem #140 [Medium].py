...
"""
very similar to single number. the difference is now that there are two numbers that appear only once

if we perform XOR operations, we will get the XOR of both numbers. question would be how to just return them just as they are?
