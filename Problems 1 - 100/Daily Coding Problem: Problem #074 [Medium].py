...
naively, construct the multiplication table and count the number of times the element appears. this would take O(N^2)
count number of pair of factors of X and then double that count, iterate from 1 to n

"""

def count_val_in_mul_table(n, x):
        count = 0
